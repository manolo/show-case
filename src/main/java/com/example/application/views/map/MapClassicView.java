...
/**
 * Imperative (pre Signals) version of the Map view. Compare with MapView for
 * the Signals based implementation that uses ValueSignal + Signal.computed +
 * Signal.effect to drive the filter, card list and map markers.
 */
@PageTitle("Map (Classic)")
@Route("map-classic")
@PermitAll
@Menu(order = 11, icon = LineAwesomeIconUrl.MAP)
public class MapClassicView extends HorizontalLayout {
