...
// Classic (pre Signals) version of Step, kept for IDE side by side comparison.
// Not wired into the live Wizard; see Step.java for the Signals based implementation.
...
public class StepClassic extends ListItem implements AfterNavigationObserver, HasTheme {
	...
	public StepClassic(String label, String description, Class<? extends Component> routeClass) {
    ...
    public StepClassic(String label, Class<? extends Component> navigationTarget) {
