...
/**
 * Imperative (pre Signals) version of the Chat view. Compare with ChatView
 * for the Signals based implementation: the unread badge uses
 * ValueSignal&lt;Integer&gt; with bindText/bindVisible and mobile detection uses
 * Page.windowSizeSignal().
 */
@PageTitle("Chat (Classic)")
@Route("chat-classic")
@PermitAll
@Menu(order = 13, icon = LineAwesomeIconUrl.COMMENTS)
public class ChatClassicView extends HorizontalLayout {
