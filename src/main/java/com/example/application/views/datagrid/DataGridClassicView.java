...
@PageTitle("Data Grid (Classic)")
@Route("data-grid-classic")
@PermitAll
@Menu(order = 5, icon = LineAwesomeIconUrl.TH_SOLID)
public class DataGridClassicView extends Div {
    ...
    private void addFiltersToGrid() {
        ...
        clientFilter.addValueChangeListener(event -> gridListDataView
                .addFilter(client -> client.getClient().toLowerCase().contains(clientFilter.getValue().toLowerCase())));
        ...
        amountFilter.addValueChangeListener(event -> gridListDataView
                .addFilter(client -> Double.toString(client.getAmount()).contains(amountFilter.getValue())));
