...
@PageTitle("Address Form (Classic)")
@Route("address-form-classic")
@PermitAll
@Menu(order = 9, icon = LineAwesomeIconUrl.MAP_MARKER_SOLID)
public class AddressFormClassicView extends Composite<VerticalLayout> {

    public AddressFormClassicView() {
