...
@PageTitle("Grid with Filters (Classic)")
@Route("grid-with-filters-classic")
@PermitAll
@Menu(order = 17, icon = LineAwesomeIconUrl.FILTER_SOLID)
@Uses(Icon.class)
public class GridwithFiltersClassicView extends Div {
    ...
    public GridwithFiltersClassicView(SamplePersonService SamplePersonService) {
