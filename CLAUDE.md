...
- **MessageAttachmentsView** - `/message-attachments` route demonstrating the now-stable `MessageListItem.setAttachments(List<Attachment>)` API with an image preview and inline data-URL file attachments
